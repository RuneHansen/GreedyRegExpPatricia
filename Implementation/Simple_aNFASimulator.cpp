...
int main() {
  ...
  S[3] = "na";
  S[4] = "1";
/* The relational function for reading an "a"
  std::string ma[25] = {"na", "0", "00", "0", "01",
    ...
    The relational function for epsilon transitions
...
*/
 ...
 // Array of relational functions (contains ma and me)
  std::string test_aNFA[50] = {"na", "0", "00", "0", "01",
                          "na", "0", "00", "0", "01",
                          "na", "", "0", "", "1",
                          "na", "0", "00", "0", "01",
                          "na", "na", "na", "na", "na",
